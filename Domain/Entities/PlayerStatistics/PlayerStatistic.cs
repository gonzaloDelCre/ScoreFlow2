...
namespace Domain.Entities.PlayerStatistics
{
    public class PlayerStatistic
    {
        ...
        {
            PlayerStatisticID = playerStatisticID
                ?? throw new ArgumentNullException(nameof(playerStatisticID));
            MatchID = matchID
            ...
            Assists = assists
                ?? throw new ArgumentNullException(nameof(assists));
            YellowCards = yellowCards
                ?? throw new ArgumentNullException(nameof(yellowCards));
            RedCards = redCards
                ?? throw new ArgumentNullException(nameof(redCards));
            Match = match
