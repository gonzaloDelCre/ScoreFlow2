...
namespace Infrastructure.Persistence.Standings.Mapper
{
    ...
    {
        public static Standing ToDomain(this StandingEntity entity,
                    League league,
                    ...
                    ICollection<PlayerEntity> playerEntities)
        {
            ...
            if (entity.Team == null) throw new InvalidOperationException($"StandingEntity {entity.StandingID} no tiene Team cargado.");
        ...
        public static StandingEntity ToEntity(this Standing domain)
        {
            return new StandingEntity
            {
                ...
                LeagueID = domain.LeagueID.Value, // ✅ NUEVO
        ...
        public static StandingEntity ToEntity(this Standing domain, TeamEntity teamEntity)
        {
            return new StandingEntity
            {
                StandingID = domain.StandingID.Value,
